...
const uint32_t nS5Timestamp = 1627466969;  //dPoW Season 5 Wed Jul 28 2021 10:09:29 GMT+0000 (timestamp of TOKEL block #1)
...
const uint32_t nS8Timestamp = 1728288000;   // dPoW Season 8, Monday, October 7, 2024 8:00:00 AM
